...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 18, 2021 at 06:43 AM
...
--
ALTER TABLE `cart`
  MODIFY `CartID` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=130;
...
--
ALTER TABLE `shippingdetails`
  MODIFY `SID` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
COMMIT;
